...
setwd("C:\\Users\\mosama\\PycharmProjects\\GP")
dfm<-read.transactions("items.csv")

#most frequent 5 items 
itemFrequencyPlot(dfm,topN=5,col="blue")

#extracting rules using eclat algo
## Mine itemsets with minimum support of 0.001, min 2 pieces and maximum 5
...
rules
inspect(rules )
write(rules, file = "matching_rules.csv", sep = ",")
