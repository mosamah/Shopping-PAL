...
#compute similarity vector
def compute_similarity_vector(img_path,coll,model_path='C:\\Users\\mosama\\PycharmProjects\\GP\\VGG_similiarity_items.h5'):
    img_path=img_path.replace("#"," ")
    title=img_path.split('\\')[-1].split(".")[0]


    print(title)
#    img_path='C:\\Users\\mosama\\PycharmProjects\\GP\\'+img_path
    print(img_path)
    ...
    updateDB(coll,title,similarity_vector.tolist())
    return
...
def compute_similarity_vector_batch(batch,model_path='VGG_similiarity_items.h5'):
    ...
    #predict sim vector
    similarity_vectors= model.predict(batch, batch_size=None, verbose=1)
...
img_file=sys.argv[1]
coll=sys.argv[-1]
compute_similarity_vector(img_file,coll)
# imgs_gen=BatchGenerator('crawled_images/Shein Images/Shein Crawled Blouses',batch_size=32)
#
#
# x,y=imgs_gen.__getitem__(i)
# print(x.shape)
#
#
...
#     print(y[idx])
#
#     updateDB('blouses',y[idx],p.tolist())
#     idx=idx+1